...
> {
  ...
  search(): this {
    ...
    if (searchTerm && searchableFields && searchableFields.length > 0) {
      ...
      const whereConditions = this.query.where as PrismaWhereCondtions;

      whereConditions.OR = searchConditions;
      const countWhereConditions =this.countQuery.where as PrismaWhereCondtions;
